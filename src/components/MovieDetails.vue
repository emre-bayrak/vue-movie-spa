      ...
      <div class="container pt-5">
        <div class="row">
          ...
          <div class="col-sm-8 details">
            ...
            <a v-for="(trailer,index) in trailers" :key="index" :href="trailer.url" class="trailer" target="_blank">
              <span></span>
              <img :src="trailer.thumbnail" />
            </a>
            <a :href="ticketsPath" class="btn btn-success tickets">Get Tickets</a>
          </div>
        </div>
      </div>
    </section>
